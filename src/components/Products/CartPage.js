...
//         renderVariations = (orderProduct) => {
//           let text = ''
//           orderProduct.product_variations.forEach((iv) => {
//             text += `${iv.variation.name}: ${iv.value}, `
//           })
//           return text
//         }

//         handleFormatData = (orderVariations) => {
//           // convert [{id: 1},{id: 2}] to [1,2] - they're all variations
//           return Object.keys(orderVariations).map((key) => {
//             return orderVariations[key].id
//           })
//         }
